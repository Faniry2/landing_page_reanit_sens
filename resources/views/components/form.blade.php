        ...
        <div class="form-box reveal fu d2">
            <form
                ...
                <div class="form-group">
                    ...
                    <input
                        class="form-input @error('nom') input-error @enderror"
                        type="text"
                        id="nom"
                        name="nom"
                        placeholder="Ton nom"
                ...
                @include('partials.phone-field-int-tel')
                ...
                {{-- <div class="form-group">
                    ...
                    <div class="form-input-icon-wrap">
                        ...
                        <input
                            class="form-input form-input-with-icon @error('whatsapp') input-error @enderror"
                            type="tel"
                            id="whatsapp"
                            name="whatsapp"
                            placeholder="+261 XX XX XXX XX"
