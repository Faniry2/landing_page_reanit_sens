...
{{-- ═══ MOBILE MENU (si dans x-nav, ignore cette ligne) ═══ --}}
...
<section class="programme-hero" id="programme">
    ...
    <div class="programme-hero-inner">
        ...
        <div class="ph-left">
            ...
            <div class="ph-actions ph-anim-3">
                <a href="#founders" class="cta-sahara">Je deviens Nomade Fondateur</a>
            ...
            <div class="ph-stat-row">
                <div class="ph-stat ph-stat-big">
                    <div class="ph-stat-icon">
                        <canvas id="flameCanvas" width="48" height="64" style="display:block;" aria-hidden="true"></canvas>
                    </div>
                    <div>
    ...
    <a href="#accroche" class="scroll-hint" aria-label="Défiler vers la section suivante">
...
<section class="accroche" id="accroche">
    <div class="accroche-blob b1" aria-hidden="true"></div>
    <div class="accroche-blob b2" aria-hidden="true"></div>
    ...
    <div class="accroche-inner">
        ...
        <div class="accroche-right">
            <div class="video-card">
                {{-- ✅ iOS fixes : playsinline + webkit-playsinline --}}
                <video
                    ...
                    data-setup='{"controls":true,"fluid":true,"responsive":true,"loop":true,"preload":"metadata"}'>
                    ...
                    <p class="vjs-no-js">
                        ...
                        qui <a href="https://videojs.com/html5-video-support/" target="_blank" rel="noopener">supporte HTML5</a>.
                    </p>
                </video>
            </div>
        </div>
...
<section class="section steps-section" id="steps">
    <div class="container">
        ...
        <div class="steps-row">
            ...
            <div class="step-arrow reveal fu d2" aria-hidden="true">›</div>
            ...
            <div class="step-arrow reveal fu d4" aria-hidden="true">›</div>
