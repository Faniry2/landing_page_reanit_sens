...
class InscriptionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'telephone' => ['required', 'string', 'regex:/^[+0-9\s\-().]{6,30}$/'],
            'whatsapp'  => ['nullable', 'string', 'regex:/^[+0-9\s\-().]{6,30}$/'],
    ...
    {
        return [
            'nom.required'       => 'Ton nom est requis.',
            'nom.min'            => 'Ton nom doit comporter au moins 2 caractères.',
            ...
            'telephone.required' => 'Ton numéro de téléphone est requis.',
